...
function f8() {
  ...
  document.querySelector(
    `.out-8`
  ).innerHTML = `<input type="text" class = "i-81" value="dfdf" /> <button class="b-81">Push</button>`;
  document.querySelector(".b-81").onclick = f81;
}

function f81() {
  document.querySelector(`.out-81`).textContent =
    document.querySelector(`.i-81`).value;
}
