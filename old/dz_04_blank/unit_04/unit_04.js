...
let checkbox1 = document.querySelector('.i4');

function f4() {
    console.log(checkbox1.checked);
    div4.textContent = document.querySelector(`.i4`).checked;
}
...
function f5() {
    if (checkbox2.checked) {
        out.textContent = checkbox2.value;
    } else {
...
function f7() {
    document.querySelector(`.out-71`).textContent = document.querySelector(`.i-7`).value;
...
function f8() {
    ...
    document.querySelector(`.out-8`).innerHTML = `<div class = "form-control"> <input type = "password" class = "i-81"> </div> <button class = "button-primary b-81" >sdgdsfg</button>`;
    document.querySelector('.b-81').onclick = f81;
}

function f81() {
    document.querySelector(`.out-81`).textContent = document.querySelector(`.i-81`).value;
...
// Task 9
//Создайте один input(radio).r-9  и button.b-9 - при нажатии на button если radio.r-9 выбран (активен, checked) выводите в 
// .out-9 - value прописанное в r-9, либо 0 если не активен. 
...
function f10() {
    out10.style.background = color.value;
    console.log(out10.className);
}
...
// Task 13
//  Создайте input(range).i-13. При изменении положения ползунка i-13 выводите 
// значение в out-13. Для события используйте oninput.
...
// Task 15
// Создайте text-area.t-15, input.i-15 и button.b-15 - при нажатии на кнопку выводите
//  текст из input.i-15 в textarea.t-15 и на страницу в out-15.

function f15() {
    document.querySelector(`textarea.t-15`).value = document.querySelector(`input.i-15`).value;
    document.querySelector(`.out-15`).textContent = document.querySelector(`input.i-15`).value;
}

document.querySelector('.b-15').onclick = f15;

// Task 16
// Создайте select.s-16 и button.b-16 - при нажатии на кнопку выводите в out-16 value выбранного
//  option из s-16.

function f16() {
    // для получения выбранного option просто получите select в переменную и select.value;
    document.querySelector(`.out-16`).textContent = document.querySelector(`select.s-16`).value;
}
...
// которого запускается функция f17. Функция должна выводить в out-17 value выбранного 
// в select option.

function f17() {
    document.querySelector(`.out-17`).textContent = document.querySelector(`select.s-17`).value;
}
...
function f18() {
    document.querySelector(`.i-18`).value = document.querySelector(`select.s-18`).value;
}
...
function f19() {
    document.querySelector(`.out-19`).textContent = `${text.value} ${pass.value}`;
}
