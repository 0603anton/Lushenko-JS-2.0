...
function f6() {
  let nodeList = document.querySelectorAll(`.p-6`);
  console.log(nodeList);
  document.querySelector(`.out-6`).textContent = nodeList.length;
}
...
function f7() {
  ...
  for (let i = 0; i < blocks7.length; i++) {
    const element = blocks7[i];
    element.classList.add(`bg-7`);
  }
}
...
function f8() {
  ...
  for (let i = 0; i < blocks8.length; i++) {
    const element = blocks8[i];
    element.classList.toggle(`bg-8`);
  }
}
...
function f12() {
  ...
  div1.classList.add(`bg-12`, `out`);
  //   div1.classList.add
  document.querySelector(`.out-12`).appendChild(div1);
}
...
function f18() {
  document.querySelector(`.out-18`).innerHTML = document
    .querySelector(`.p-18`)
    .getAttribute(`data-b`);
}
...
function f19() {
  ...
  for (let i = 0; i < p19.length; i++) {
    ...
    document.querySelector(`.out-19`).innerHTML +=
      ` ` + `<br>` + element.getAttribute(`data-b`);
  }
}
