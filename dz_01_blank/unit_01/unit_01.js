...
document.querySelector(".one").innerHTML = `hello world11`;
...
document.querySelector(`h2`).innerHTML = `<h2>Hello <span>world</span></h2>`;

// Task 10.
//Создайте пустой div c классом three. С помощью querySelector запишите внутрь div заголовок h3 с произвольным текстом.

document.querySelector(`.three`).innerHTML = `<h3>Ho-ho-ho</h3>`
...
document.querySelector(`.four`).innerHTML += `йоба <p> бляъха затупил на 10 минут</p>`
...
document.querySelector(`.divided`).innerHTML = y1 / y2;
